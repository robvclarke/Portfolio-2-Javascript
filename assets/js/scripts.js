...
function checkAnswer(userAnswer) {
    ...
    if (questions[question].answer === userAnswer) {
        ...
        console.log(lives);
        if (lives === 0) {
            window.location.href = '/Portfolio-2-Javascript/gameover.html?score=' + points; //  redirect to gameover screen
        }
    }

    question++; // add 1 to question
    if (question === 10) {
        window.location.href = '/Portfolio-2-Javascript/quizcomplete.html?score=' + points; // Go to Quiz Complete page after final question
    }
